...
async function loadWorkbookData() {
  ...
  if (!response.ok) {
    throw new Error(`Could not download Excel file. Status: ${response.status}`);
  }
      ...
      <div className="hero-card">
        <div>
          ...
          <p className="subtitle">
            Search by <strong>PO Number</strong> or <strong>Position No</strong>. The app reads data from your Excel file and shows the latest shipment details.
          </p>
        </div>
        <div className="status-box">
          ...
          <p>
            {source === 'excel'
              ...
              : 'Demo mode is active until you paste your public OneDrive download link in src/App.jsx.'}
          </p>
        </div>
      </div>
      ...
      <div className="results-section">
        ...
        {!hasSearch && !loading && (
          <div className="empty-card">
            Enter a value above to search shipments.
          </div>
        )}
